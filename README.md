...
**Source Code**: <a href="https://gitlab.com/juanesquintero/fastapi-quickstart" target="_blank"> https://gitlab.com/juanesquintero/fastapi-quickstart </a>
...
### Run
  python run.py
  run.py file has run parameters

### Config
  .env file env variables
  config has app config
